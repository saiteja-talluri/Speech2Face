    ...
    def extract_video(self, id, x, y):
        ...
        with tf.Graph().as_default():
            with tf.compat.v1.Session() as sess:
                ...
                ip = tf.compat.v1.get_default_graph().get_tensor_by_name("input:0")
                embedding = tf.compat.v1.get_default_graph().get_tensor_by_name("embeddings:0")
